...
public static class ParameterExtensions
{
    ...
    private static string GetAnfrageZeitpunkt(this ConnectionRequest request)
    {
        ...
        throw new BahnDeException("ConnectionSuggestion", "Neither departureTime nor arrivalTime has been set");
    }
    ...
    {
        if(passenger.Age is null) throw new BahnDeException("ConnectionSuggestion", "Passenger with birthday is not supported yet");
    ...
    {
        if(discount.ValidUntil is not null) throw new BahnDeException("ConnectionSuggestion", "Discount with validity date is not supported yet");
    ...
    private static List<Zwischenhalt> GetZwischenhalte(this ConnectionRequest request)
    {
        ...
        if (request.Route.FirstStopOver is not null)
        {
            ...
            if(allowedVehicles is null) throw new BahnDeException("ConnectionSuggestion", "Allowed vehicles not set for first stopover");
        ...
        if (request.Route.SecondStopOver is not null)
        {
            ...
            if(allowedVehicles is null) throw new BahnDeException("ConnectionSuggestion", "Allowed vehicles not set for second stopover");
