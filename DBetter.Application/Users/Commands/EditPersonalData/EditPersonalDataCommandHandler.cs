...
public class EditPersonalDataCommandHandler(IUserRepository repository) : CommandHandlerBase<EditPersonalDataCommand, EditPersonalDataResult>
{
    public override async Task<CanFail<EditPersonalDataResult>> Handle(EditPersonalDataCommand request, CancellationToken cancellationToken)
    {
