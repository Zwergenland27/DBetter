...
public static class TrainCompositionErrors
{
    ...
    public static Error MorePreciseInformationAvailable => Error.Conflict(
        "TrainComposition.MorePreciseInformationAvailable",
        "Cannot assign a new planned train part after assigning resolved train parts.");
